...
const MainLayout = ({ children }) => {
  ...
  const getStudent = () => {
    let stu = JSON.parse(crypto.decrypt(Cookies.get("PUSER")));
    // console.log(stu);
    ...
    <>
      <div className="h-full">
        <Head>
          ...
          <meta
            name="description"
            content="Generated by create next app and phynocut solutions"
          />
                              ...
                              {({ active }) => (
                                <span
                                  onClick={() => {
                                    ...
                                    Cookies.remove("PUSER");
                                    Router.push("signin");
                                  }}
                                  className={classNames(
                                    active ? "bg-gray-100" : "",
                                    "block py-2 px-4 text-sm text-gray-700 hover:curser-pointer"
                                  )}
                                >
                                  {item.name}
                                </span>
